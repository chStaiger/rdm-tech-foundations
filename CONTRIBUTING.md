# Contributing To _RDM Tech Foundations_

**Welcome to _RDM Tech Foundations_ repository!**
...
Please read through our [Code of Conduct](CODE_OF_CONDUCT.md) and make sure you familiarise yourself with its contents. We expect all of our contributors to comply with the terms specified there.



## How can I contribute?
You can contribute to the Data Privacy Handbook in the following ways:
- Coming up with ideas for the handbook or let us know about errors or bugs, by [opening an Issue on GitHub](https://github.com/chStaiger/rdm-tech-foundations/issues)
...
- Commit changes.
- Open a pull request to _RDM Tech Foundations_'s repository.
