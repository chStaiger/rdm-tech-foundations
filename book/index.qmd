...
This book presents the infrastructure of Research Data Management (RDM): the systems, standards, workflows, and architectural patterns that enable data stewards to support research that is aligned with the FAIR (Findable, Accessible, Interoperable, Reusable) Principles throughout the data lifecycle.
