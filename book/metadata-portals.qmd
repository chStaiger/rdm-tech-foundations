...
digraph metadata_flow {
    ...
    subgraph cluster_consumer {
        ...
        USER [label="Researchers and Machines"];
    }
    ...
    subgraph cluster_repository {
        ...
        API  [label="Expose Metadata\nvia OAI-PMH / REST API"];
        META -> API [label="offered through"];
    }
    ...
    subgraph cluster_metadata {
        ...
        HARV  [label="Harvester\nCollect & Normalise"];
        INDEX [label="Indexer\nSearch Index / Knowledge Graph"];
        PORTAL [label="Metadata Portal\nDiscovery Interface"];
        HARV  -> INDEX  [label="provide harvested metadata"];
        INDEX -> PORTAL [label="serve indexed metadata"];
    }

    /* --- Triangle layout --- */

    /* Top rank: Consumer */
    { rank = same; TOP_ANCHOR; }

    /* Bottom rank: Repository + Metadata Service */
    { rank = same; LEFT_ANCHOR; RIGHT_ANCHOR; }

    /* --- Edges --- */
    USER -> PORTAL [label="search / explore"];
    USER -> DATA   [label="access & download"];
    API  -> HARV   [label="offer metadata"];
}
```
...
digraph linkeddata_flow {
    ...
    subgraph cluster_repository {
        ...
        DATA     [label="Data Files"];
        RDF      [label="RDF Metadata\n(Turtle, JSON-LD, RDF/XML)"];
        ENDPOINT [label="Expose RDF\nvia Content Negotiation / API"];

        RDF -> ENDPOINT [label="published as RDF"];
    }
    ...
    subgraph cluster_linkeddata {
        ...
        TRIPLE [label="Triple Store\n(GraphDB, Blazegraph, Fuseki)"];
        SPARQL [label="SPARQL Endpoint\nQuery Interface"];

        TRIPLE -> SPARQL [label="query graph"];
    }
    ...
    ENDPOINT -> TRIPLE [label="load RDF graphs"];

    /* --- Consumer interactions --- */
    USER -> SPARQL [label="query / explore"];
    USER -> DATA   [label="access and download"];
}
```