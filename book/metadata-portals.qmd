...
digraph metadata_flow {
    ...
    subgraph cluster_repository {
        ...
        fontsize=18;
        style=filled;
        color="#E4F0D1";   /* very pale background */

        REP_ANCHOR [shape=point, width=0, label="", style=invis];

        node [fillcolor="#DAEAB4"];   /* original node colour */
        DATA [label="Data Files"];
        META [label="Local Metadata\n(JSON, XML, RDF)"];
        API  [label="Expose Metadata\nvia OAI-PMH / REST API"];
        META -> API [label="offered through", fontcolor="#FFA552"];
    }
    ...
    subgraph cluster_metadata {
        ...
        META_ANCHOR [shape=point, width=0, label="", style=invis];

        node [fillcolor="#DAEAB4"];   /* original node colour */
        HARV  [label="Harvester\nCollect & Normalise"];
        INDEX [label="Indexer\nSearch Index / Knowledge Graph"];
        PORTAL [label="Metadata Portal\nDiscovery Interface"];
        HARV  -> INDEX  [label="provide harvested metadata", fontcolor="#FFA552"];
        INDEX -> PORTAL [label="serve indexed metadata", fontcolor="#FFA552"];
    }

    /* --- Force horizontal alignment --- */
    { rank = same; REP_ANCHOR; META_ANCHOR; }
    ...
    subgraph cluster_consumer {
        ...
        node [fillcolor="#CDE498"];   /* original highlight colour */
        USER [label="Researchers and Machines"];
    }

    /* --- Consumer interactions --- */
    USER -> PORTAL [label="search / explore", fontcolor="#FFA552"];
    USER -> DATA   [label="access & download", fontcolor="#FFA552"];

    /* --- Metadata flow --- */
    API -> HARV [label="offer metadata", fontcolor="#FFA552"];
}
```
