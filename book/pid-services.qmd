...
digraph pid_frameworks {
    ...
    subgraph cluster_epic {
        ...
        EPIC [label="EPIC\n(Persistent identifiers for European research)"];
    }
...
> **EPIC provides a more general handle-based PID service that can be used for datasets, research infrastructures, software, and other digital assets.**
