...
Files are the _content_ component of a digital object. This chapter examines how they behave and evolve across the research data life cycle.

## What Are Files in Research Data Management?

Every digital research project begins with files. They are the most immediate and tangible artefacts that researchers work with: a CSV exported from an instrument, a TIFF image from a microscope, a NetCDF model output, a PDF protocol, or a collection of scripts and notebooks. In Research Data Management (RDM), files are the basic units of digital content and the raw material from which more structured research outputs are eventually created.
...
- they rarely have persistent identifiers (PIDs),  
- they are not yet accompanied by curated metadata,  
- metadata and provenance still need to be captured from the start.

This is where FAIR already matters. Early decisions about naming, formats, folder structures, and documentation directly influence how findable, accessible, interoperable, and reusable the data will be later when files are eventually curated and published.
...
- components with independent value _may_ be published as separate digital objects,  
...
During the _Process_ and _Analyse_ stages, it is appropriate to speak primarily about files, because researchers interact with them as working artefacts. But once these files are stabilised, preserved, or prepared for dissemination, they transition into digital objects.

This conceptual shift reflects the reality of the research data life cycle: files are the raw materials; digital objects are the curated, managed, and preservable units that persist beyond the immediate research workflow.
...
As files take on this more durable role, their meaning increasingly depends on the descriptive information that accompanies them. This includes information how they were created, what they contain, and how they relate to other research outputs. The next chapter explores this descriptive layer: the [metadata](metadata.qmd) that makes digital objects findable, understandable, and reusable across the research data life cycle.